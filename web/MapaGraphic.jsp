...
<html>
    ...
    <body>
        ...
        <div style="background-color: white;">
            <h1 style="text-align: center; background-color: white; font-family: Arial, sans-serif ;">MAPA ITERATIVO DE LA SEDE DEL SUR  </h1>

            <form class="mb-3" id="dijkstraForm" method="post" action="#" style="margin-top: 15px; text-align: center;">
                <label class="lead" for="startVertex">Punto de Salida</label>
                <select class="form-select-lg mb-3" id="startVertex" name="startVertex">
                    <option value="">Selecciona un punto</option>
                    <option value="Edificio 4600">Edificio 4600</option>
                    <option value="Edificio 4000">Edificio 4000</option>
                    <option value="Auditorio" >Edificio 4000</option>
                </select>

                <label class="lead" for="endVertex">Punto de llegada:</label>
                <select class="form-select-lg mb-3" id="endVertex" name="endVertex">
                    <option value="">Selecciona un punto</option>
                    <option value="Edificio 4600">Edificio 4600</option>
                    <option value="Edificio 4000" >Edificio 4000</option>
                    <option value="Auditorio" >Edificio 4000</option>
                ...
                <button class="btn" type="submit" style="background-color: #00c0f3; margin-left: 4px; margin-bottom: 4px;">Calcular Ruta</button>
            </form>
